...
public class CreateInvoice {
	...
	a.add(new Invoices(4, "Pen", 100, 25.0, new SimpleDateFormat("MM/dd/yyyy").parse("01/02/2020")));
	...
	a.add(new Invoices(8, "Pen", 100, 25.0, new SimpleDateFormat("MM/dd/yyyy").parse("01/02/2020")));
	...
	a.add(new Invoices(12, "Pen", 100, 25.0, new SimpleDateFormat("MM/dd/yyyy").parse("01/02/2020")));
